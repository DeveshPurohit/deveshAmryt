  ...
  return (
    <div className="chart-wrapper mx-auto flex max-w-7xl flex-col flex-wrap items-start justify-center gap-6 p-6 sm:flex-row sm:p-8">
      ...
      <div className="grid w-full gap-6 sm:grid-cols-2 lg:max-w-[22rem] lg:grid-cols-1 xl:max-w-[25rem]">
        ...
        <Card className="flex flex-col lg:max-w-md shadow-md" x-chunk="charts-01-chunk-1">
      ...
      <div className="grid w-full flex-1 gap-6">
        ...
        <Card className="max-w-xs shadow-md" x-chunk="charts-01-chunk-6">
        ...
        <Card className="max-w-xs shadow-md" x-chunk="charts-01-chunk-7">
